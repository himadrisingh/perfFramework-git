...
/**
 * Take perf framework state dump
 *
 * @author Himadri Singh
 * @goal dump-state
 */
public class MasterDumpStateMojo extends AbstractMojo {
  ...
  public MasterDumpStateMojo() {
  }

  public MasterDumpStateMojo(MasterDumpStateMojo mojo) {
    setLog(mojo.getLog());
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    getLog().info("---------------------------------------");
    getLog().info(" Starting Perf Framework - State Dump ");
    getLog().info("---------------------------------------");
    BootStrap.dumpState();
  }
}
